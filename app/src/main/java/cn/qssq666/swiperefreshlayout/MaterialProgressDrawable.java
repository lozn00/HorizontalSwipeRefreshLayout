...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /**
     * Set the start and end trim for the progress spinner arc.为进步旋弧设置开始和结束的装饰。
     *
    ...
    /**
     * Set the amount of rotation to apply to the progress spinner.设置旋转量申请进度微调。
     *
    ...
    public float getPogressRotation() {
     ...
     * the next color.更新环的颜色，如果这是在最后25%的动画。
     * 新的环的颜色将是从起始环颜色的翻译
     * 下一个颜色..
     */
